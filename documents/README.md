...
[Litvis concepts](#Litvis-concepts)<br>
[Literate code blocks](#Literate-code-blocks)<br>
[Triple hat references](#Triple-hat-references)<br>
[Branching narratives](#Branching-narratives)<br>
[Elm configuration](#Elm-configuration)<br>
[Narrative schemas](#Narrative-schemas)<br>
[Getting started](#Getting-started)<br>

## Litvis concepts <a name="Litvis-concepts"></a>
...
### Literate code blocks <a name="Literate-code-blocks"></a>
...
The arguments that determine the behavior of the block should be placed inside `{}` and should not contain line breaks.
...
- Values can be surrounded by round brackets.
  ...
  Surrounding attribute values with brackets can be useful when using triple hat references ([see below](#Triple-hat-references)).
...
### Triple hat references <a name="Triple-hat-references"></a>
...
They use the same attribute syntax as literate code blocks and recognize the following keys:
...
Rendering of a parameterized spec:
...
### Branching narratives <a name="Branching-narratives"></a>
...
### Elm configuration <a name="Elm-configuration"></a>
...
When a downstream document declares a set of Elm dependencies, they are merged with any mentioned upstream, but will not affect the behavior of the upstream documents.

In rare cases, a package used in an upstream document needs to be excluded in a branch in favor of a local Elm module (for example, to test a new development version of a library).
...
### Narrative schemas <a name="Narrative-schemas"></a>
...
Unlike the HTML tags that could also be utilized, narrative schema labels starting with `{(` and `{|` remain visible in non-litvis markdown previews such as GitHub.
...
## Getting started with litvis <a name="Getting-started"></a>
